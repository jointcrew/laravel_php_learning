...
<script src="{{ asset('js/goods_ajax.js?20200818') }}" defer></script>
                                  ...
                                  <form action='/api/api_goodsuser'  id="the_form">
                                      ...
                                      <div class="">
                                          <table class="table table-striped table-hover">
                                              ...
                                              <tr>
                                                  <td id="user_name_id"></td>
                                                  <td id="goods_name_id"></td>
                                                  <td id="purchase_number_id"></td>
                                                  <td id="total_price_id"></td>
                                                  <td id="discount_price_id"></td>
